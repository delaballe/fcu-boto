"""Object-oriented interface to SWF wrapping fcu_boto.swf.layer1.Layer1"""

import time
from functools import wraps
from fcu_boto.swf.layer1 import Layer1
from fcu_boto.swf.layer1_decisions import Layer1Decisions
...
class Domain(SWFBase):
    ...
    def executions(self, closed=False, **kwargs):
        ...
        :py:func:`fcu_boto.swf.layer1.Layer1.list_closed_workflow_executions` and
        :py:func:`fcu_boto.swf.layer1.Layer1.list_open_workflow_executions`
        """
        if closed:

...
from fcu_boto.sdb.db.property import StringProperty, IntegerProperty, BooleanProperty
from fcu_boto.sdb.db.property import DateTimeProperty, FloatProperty, ReferenceProperty
from fcu_boto.sdb.db.property import PasswordProperty, ListProperty, MapProperty
from fcu_boto.exception import SDBPersistenceError
...
#
# This will eventually be moved to the fcu_boto.tests module and become a real unit test
